...
```{r plot_dist_to_centrom_vs_dist_to_telom,include=FALSE}
...
```
\newpage
Plot 1. Expected heterozygosity versus observed heterozygosity on all variants on chr 22  
![](/Users/aachueva/Desktop/1_plot.png)

\newpage
# Fraction of high hets over all chromosomes  
![](/Users/aachueva/Desktop/frac_over_all.png)  
